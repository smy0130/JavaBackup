...
public class GoodsInfo extends GoodsManager {
	...
	public GoodsInfo(int iGoodsCode, String sGoodsName, int iGoodsPrice, String sManufactuer, String sDescrption) {
		super();
		this.iGoodsCode = iGoodsCode;
		this.sGoodsName = sGoodsName;
		this.iGoodsPrice = iGoodsPrice;
		this.sManufactuer = sManufactuer;	
		this.sDescrption = sDescrption;
	}
